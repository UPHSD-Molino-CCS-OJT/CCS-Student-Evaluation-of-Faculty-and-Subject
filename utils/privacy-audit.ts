        ...
        try {
            ...
            if (actualCodeReferences > 0) {
                this.addWarning(
                    ...
                    `Found ${actualCodeReferences} uncommented student_number references in privacy audit code.`,
                ...
                this.addWarning(
                    ...
                    'Privacy audit code properly avoids logging student identifiers in code.',
