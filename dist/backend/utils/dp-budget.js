...
class DPBudgetTracker {
     ...
     */
    generateQueryId(queryType, parameters) {
     ...
     */
    async executeQuery(request, computeFunction) {
        try {
            this.rotateWindowIfNeeded();
...
DPBudgetTracker.DEFAULT_CONFIG = {
...
exports.default = DPBudgetTracker;
//# sourceMappingURL=dp-budget.js.map