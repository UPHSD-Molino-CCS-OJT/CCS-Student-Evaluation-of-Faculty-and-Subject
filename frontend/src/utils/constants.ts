...
import type { RatingScale, EvaluationSections, EvaluationQuestion, FormData } from '../types';
...
export const EVALUATION_SECTIONS: EvaluationSections = {
  teacher: {
...
export const ALL_QUESTIONS: EvaluationQuestion[] = Object.values(EVALUATION_SECTIONS)
  .flatMap(section => section.questions);

// Get question by ID
export const getQuestionById = (id: string): EvaluationQuestion | undefined => {
...
export const getFirstUnansweredQuestion = (formData: FormData): EvaluationQuestion | undefined => {
  return ALL_QUESTIONS.find(q => !formData[q.id] || formData[q.id] === '');
};

// Get average rating
export const calculateAverageRating = (formData: FormData): string => {
